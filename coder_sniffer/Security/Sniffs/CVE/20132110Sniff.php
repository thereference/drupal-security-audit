...
class CVE20132110Sniff implements \PHP_CodeSniffer_Sniff {
	...
	*/
	public function process(\PHP_CodeSniffer_File $phpcsFile, $stackPtr) {
		...
		if ($tokens[$stackPtr]['content'] == 'quoted_printable_encode') {
			...
			$s = $phpcsFile->findNext(array_merge(\PHP_CodeSniffer_Tokens::$emptyTokens, \PHPCS_SecurityAudit\Sniffs\Utils::$staticTokens), $s + 1, $closer, true);
			if ($s) {
